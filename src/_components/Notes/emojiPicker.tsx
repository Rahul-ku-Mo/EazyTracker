...
export default function EmojiPicker({ currentEmoji, onEmojiSelect, onEmojiRemove }: EmojiPickerProps) {
  ...
  return (
    <div className="relative">
      <div
        ...
        className="emoji-picker-trigger inline-flex items-center gap-2 cursor-pointer px-2 py-1 rounded-md hover:bg-zinc-100 dark:hover:bg-zinc-800 opacity-0 hover:opacity-100 transition-opacity duration-200"
      >
