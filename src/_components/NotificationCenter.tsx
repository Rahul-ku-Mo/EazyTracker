  ...
  return (
    <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
      <DropdownMenuTrigger asChild>
          <div className="relative size-7 rounded-sm hover:bg-zinc-100 dark:hover:bg-zinc-800 flex items-center justify-center ml-2">
          <Bell className="size-4" />
          {unreadCount > 0 && (
            <div className="absolute -top-2 -right-2 size-3 flex items-center justify-center p-0 text-xs">
