...
export function InviteUserIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
...
export function MemberIcon(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M3.5 21.23q-.213 0-.356-.143Q3 20.943 3 20.73t.144-.356t.356-.143h17q.213 0 .356.144t.144.356t-.144.356t-.356.144zM5.808 19q-.343 0-.576-.232T5 18.192v-3.884q-.863-1.716-1.304-3.305q-.44-1.59-.44-3.01q0-1.18.3-2.453q.302-1.273.923-2.948q.084-.256.284-.424T5.244 2q.333 0 .556.266q.223.265.18.605l-.255 2.064q-.15 1.315.318 2.582T7.4 9.78t2.087 1.608T12 12q1.558 0 2.83.216q1.272.217 2.166.638q.952.46 1.478 1.184T19 15.85v2.342q0 .344-.232.576t-.576.232H9.54v-.406q0-.985.685-1.674q.686-.69 1.699-.69h2.885q.212 0 .356-.143q.144-.144.144-.357t-.144-.356t-.356-.143h-2.885q-1.406 0-2.395.978q-.99.98-.99 2.385V19zM12 10.539q-1.237 0-2.119-.882T9 7.54t.881-2.12T12 4.54t2.119.88T15 7.54t-.881 2.118T12 10.54"
      />
    </svg>
  );
}
...
export function AccessLevelIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
export function RecommendationIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M11.975 22.9q-.275 0-.55-.112q-.275-.113-.5-.338l-9.375-9.4q-.225-.225-.325-.5t-.1-.55q0-.275.1-.55t.325-.5l9.375-9.4q.225-.225.5-.338q.275-.112.55-.112t.563.112q.287.113.512.338l9.4 9.4q.225.225.325.5t.1.55q0 .275-.1.55t-.325.5l-9.4 9.4q-.225.225-.512.338q-.288.112-.563.112ZM12 18l1.85-4.15L18 12l-4.15-1.85L12 6l-1.85 4.15L6 12l4.15 1.825Z"
      />
    </svg>
  );
}
...
export function TotalWorkspaceIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M4.5 19q-.633 0-1.066-.434Q3 18.133 3 17.5V6.616q0-.633.491-1.125Q3.983 5 4.615 5h4.981l2 2h7.789q.517 0 .903.28t.539.72H4v9.385q0 .211.106.346t.279.23l2.265-7.576h16.216l-2.268 7.556q-.142.476-.545.768q-.403.291-.9.291z"
      />
    </svg>
  );
}

export function MaxTaskIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
export function TotalTaskIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M2.5 5.5v-4h4v1h-3v3zm18 0v-3h-3v-1h4v4zm-18 17v-4h1v3h3v1zm15 0v-1h3v-3h1v4zm-10.384-3q-.691 0-1.153-.462T5.5 17.884V6.116q0-.691.463-1.153T7.116 4.5h9.769q.69 0 1.153.463t.462 1.153v11.769q0 .69-.462 1.153t-1.154.462zM9.5 9.5h5v-1h-5zm0 3h5v-1h-5zm0 3h5v-1h-5z"
      />
    </svg>
  );
}

export function ProBillingIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
export function CrownBillingIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
export function TargetCompleteIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
export function StatusIcon(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M6 1q.417 0 .816.066l-.936.936a4 4 0 1 0 4.118 4.124l.937-.936Q11 5.585 11 6a5 5 0 1 1-5-5m4.441.562a1.914 1.914 0 0 0-2.707 0L5.15 4.146a.5.5 0 0 0-.12.194l-.984 2.92a.55.55 0 0 0 .696.697l2.92-.982a.5.5 0 0 0 .195-.12l2.584-2.585a1.914 1.914 0 0 0 0-2.707m-2 .707a.914.914 0 0 1 1.293 1.293l-2.502 2.5l-1.949.656l.656-1.948z"
      />
    </svg>
  );
}
...
export function EmptyIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      {/* Icon from Subway Icon Set by Mariusz Ostrowski - https://creativecommons.org/licenses/by/4.0/ */}
      <path
        fill="currentColor"
        d="M85.3 21.3H42.7V64h42.7V21.3zM42.7 490.7h42.7v-256H42.7zm384 0h42.7V448h-42.7zm42.6-469.4h-42.7v256h42.7zm-192 0h-42.7v149.3h42.7zm-42.6 469.4h42.7V341.3h-42.7zM0 192h128v-85.3H0zm192 106.7h128v-85.3H192zM384 320v85.3h128V320z"
      />
    </svg>
  );
}
...
export function LabelIcon(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M4 22V6h12v16l-6-3zm2-3.025l4-2.15l4 2.15V8H6zM18 18V4H7V2h13v16zM6 8h8z"
      />
    </svg>
  );
}

export function AdditionalInfoIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
export function TimeTrackingIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
export function NullIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
    ...
    >
      ...
      <path
        fill="currentColor"
        d="m5.002 12.412l-.962.962a1 1 0 0 1-1.414-1.414l.962-.962a5.333 5.333 0 0 1 7.41-7.41l.962-.962a1 1 0 1 1 1.414 1.414l-.962.962a5.333 5.333 0 0 1-7.41 7.41m.966-.966a4 4 0 0 0 5.478-5.478zm-1.414-1.414l5.478-5.478a4 4 0 0 0-5.478 5.478"
      />
    </svg>
  );
}
