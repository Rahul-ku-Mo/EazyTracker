    ...
    <div className="h-full lg:flex flex-col fixed right-0 w-[310px] hidden">
      <div className="p-4 px-2.5 flex flex-col gap-2.5 flex-1 border-r border border-border">
        <div className="flex flex-col gap-4">
          ...
          <h2 className="text-sm font-semibold rounded-md p-2 pb-4">
          ...
          <div className="flex justify-between items-center rounded-md p-2">
            <div className="flex items-center gap-2">
              <span className="text-sm font-medium text-primary">Due Date</span>
            </div>

            {dueDate ? (
              <div className="flex items-center gap-2">
                <div
                  className={`px-1.5 py-1 text-xs font-medium rounded-md inline-flex items-center gap-1.5 ${
                    isToday(dueDate)
